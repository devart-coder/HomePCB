...
void ScenePCB::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->getCrossArrowsPosition((*reinterpret_cast<std::add_pointer_t<QPointF>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ScenePCB::*)(const QPointF & )>(_a, &ScenePCB::getCrossArrowsPosition, 0))
            return;
...
// SIGNAL 0
void ScenePCB::getCrossArrowsPosition(const QPointF & _t1)
{
