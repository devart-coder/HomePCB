...
#include "PCBScene.h"
#include <PCBCursor.h>
#include "PCBCursorToolbar.h"
#include "PCBGraphicsViewer.h"
#include "PCBGCodeWidget.h"
#include <QStatusBar>
#include <QLabel>
#include <QPushButton>
#include <QToolBar>
...
private:
    Q_OBJECT
    GraphicsViewer* pcbViewer = new GraphicsViewer(new ScenePCB(QRectF(0,0,250*10,250*10),QBrush(Qt::black)));
